			...
			<div class="container">
				<div class="signup-content">
					...
					<div class="signup-image">
						<figure>
							<img src="images/WhatsApp Image 2022-02-22 at 19.40.09.jpeg" alt="sing up image" width="780" height="502">
						</figure>
...
if(status == "success"){
	...
	if(status == "invalidName"){
		...
		if(status == "invalidEmail"){
			swal("Congrats","Enter valid Email"," error");
			if(status == "invalidpwd"){
				...
				if(status == "invalidMobile"){
					swal("Congrats","Please Enter Valid Mobile "," error");
					if(status == "invalidMobileLength"){
						swal("Congrats","Number Should be of 10 Digits" "," error");
